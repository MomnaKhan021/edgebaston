...
export const HOME_TEMPLATE: TemplateDef = {
  ...
  sections: [
    ...
    },
    {
      ...
      description: "Heading and the course cards. Add, remove and reorder cards — with 4+ cards the section becomes a slider. Each card links to the page in its Card link field; the whole card is clickable.",
      fields: [
        toggle(),
        ...
        list("cards", "Course cards", "Card", [
          text("title", "Title"),
          textarea("body", "Text"),
          text("stat", "Stat value", "Any text — e.g. +1.78, 90% or 72.7%."),
    ...
    },
    {
      ...
      fields: [
        ...
        text("rankingLabel", "Left card — heading"),
        text("rankingValue", "Left card — figure", "Any text, e.g. #25 or Top 25."),
        text("rankingCaption", "Left card — caption"),
        text("valueAddedLabel", "Right card — heading"),
        text("valueAddedValue", "Right card — figure", "Any text, e.g. #1 or +0.59."),
        text("valueAddedCaption", "Right card — caption"),
    ...
    },
    {
      ...
      fields: [
        ...
        text("moreLabel", "'See more' button label"),
        text("profileLabel", "Featured card link label"),
        url("moreUrl", "Success stories link", "Where 'View full profile' and the 'See more' button link. Leave empty to hide them."),
        toggle("gridLayout", "Show as a grid", "Tick to lay the stories out as a grid. Leave unticked to show the swiper (default)."),
        color(),
        ...
        ], "In swiper mode the first student is also shown as the large featured card on desktop."),
      ],
      defaults: {
        visible: "1",
    ...
    },
    {
      ...
      fields: [
        ...
        text("label", "Small label"),
        text("title", "Heading"),
        text("moreLabel", "'View blog' button label"),
        text("tag", "Card category label", "The category prefix shown before each article's date."),
        text("readLabel", "'Read Article' button label"),
        url("moreUrl", "Blog link", "Where the button below the articles links. Leave empty to hide it."),
        color(),
  ...
  sections: [
    ...
    },
    {
      ...
      defaults: {
        ...
        items: "[{\"label\":\"Enquire About A Course\",\"url\":\"/inquiry\"},{\"label\":\"One Year A-Level Retake Programme\",\"url\":\"/one-year-a-level-retake\"},{\"label\":\"Our Courses\",\"url\":\"/courses\"},{\"label\":\"Admissions Requirements\",\"url\":\"/admissions-requirements\"},{\"label\":\"About Us\",\"url\":\"/about-us\"},{\"label\":\"Our History\",\"url\":\"/our-history\"}]",
      },
    },
    {
      key: "address",
...
export const RESULTS_TEMPLATE: TemplateDef = {
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        toggle(),
        textarea("years", "Years", "One year per line — shown as buttons left to right. (Only used when no year tabs are set up below.)"),
        text("activeYear", "Default selected year", "Which year is shown first, e.g. 2025."),
        text("buttonLabel", "Button label"),
        url("buttonUrl", "Button link"),
        list(
          "yearData",
          "Year tabs (per-year results)",
          "Year",
          [
            ...
            textarea("subjects", "Subject bars", 'One per line as "Subject | Grade | Percent", e.g. "Biology | A*–A | 71.0".'),
            text("gradesValue", "Grades gained figure", "e.g. +1.78"),
            text("dest1Value", "Destination 1 value (%)", "Number only, e.g. 72.7"),
            text("dest2Value", "Destination 2 value (%)", "Number only, e.g. 92"),
          ],
          "Each year becomes a clickable tab that shows that year's results. Shared labels (small label, stat labels, subject/destination headings, story card) come from the sections below. Leave empty to show the single Results Summary below instead.",
        ),
        color(),
      ],
      defaults: {
...
export const SUCCESS_STORIES_TEMPLATE: TemplateDef = {
  key: "success-stories",
  name: "What Our Students Say Page",
  description: "The success-stories page (/what-our-students-say) — banner and the student story cards.",
  sections: [
    {
      key: "hero",
      name: "Banner",
    ...
    },
    {
      key: "stories",
      name: "Success Stories",
      description: "Heading and the student story cards. Add, remove and reorder cards — changes go live on save.",
      fields: [
        toggle(),
        text("eyebrow", "Small label"),
        text("heading", "Heading"),
      ...
      defaults: {
        visible: "1",
        eyebrow: "Success Stories",
        heading: "Real students, real grade jumps",
        subtitle: "See how a year at Edgbaston College transformed their results — and their futures.",
        cards: JSON.stringify([
          { name: "Alishba", image: "/figma/pathway-1.webp", from: "BB", to: "A*A*", course: "Law at University of Cambridge", quote: "The career guidance was absolutely transformative for me. Umar's Chemistry teaching helped me jump from a D to an A, whilst Owais's university advice gave me clear direction for my future." },
          { name: "Nicole", image: "/figma/news-1.webp", from: "BB", to: "A*A*", course: "Dentistry at King's College London", quote: "The small classes and weekly mock exams gave me the confidence to jump from BB to A*A* and secure my dentistry place." },
          { name: "Tara", image: "/figma/news-2.webp", from: "BB", to: "AA", course: "Medicine at Edge Hill University", quote: "The personalised UCAS support was the difference — I reapplied and finally got my medicine offer." },
