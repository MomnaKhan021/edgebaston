...
function InfoCard({ label, title, body, place }: Info) {
  return (
    <div className={"rounded-lg bg-eb-cream p-5 sm:rounded-xl sm:p-7 " + (place ?? "")}>
      <div>
    ...
    <section className="bg-eb-navy">
      <div className="mx-auto max-w-[1440px] px-4 pb-10 pt-10 lg:px-10 lg:pb-10 lg:pt-20">
        ...
        <div className="relative mt-[60px] grid grid-cols-[1fr_auto_1fr] items-center gap-2 sm:gap-4">
          {/* Left box — higher */}
          <div className="z-10 -translate-y-4 rounded-lg bg-white/[0.08] p-3 text-center sm:rounded-xl sm:p-[26px] lg:-translate-y-8">
            <p className="font-mono text-[11px] font-medium text-white sm:text-[16px]">National Ranking</p>
          ...
          <div className="relative flex justify-center">
            ...
            <img src="/figma/door.svg" alt="" className="h-40 w-auto sm:h-56 lg:h-72" loading="lazy" decoding="async" />
            {/* Lower-left connector: left of the door, near its base */}
            <svg className="pointer-events-none absolute right-full top-[62%] z-20 mr-1 block w-11 sm:w-16 lg:w-[98px]" viewBox="0 0 104 69" fill="none" aria-hidden>
            ...
            <svg className="pointer-events-none absolute left-full top-[16%] z-20 ml-1 block w-11 sm:w-16 lg:w-[98px]" viewBox="0 0 104 69" fill="none" aria-hidden>
          ...
          <div className="relative z-10 translate-y-4 rounded-lg bg-white/[0.08] p-3 text-center sm:rounded-xl sm:p-[26px] lg:translate-y-10">
            <Medal className="absolute left-2 top-2 h-6 w-6 sm:left-4 sm:top-3 sm:h-8 sm:w-8" />
            <p className="font-mono text-[11px] font-medium text-white sm:text-[16px]">Value Added</p>
        ...
        <div className="mt-8 grid grid-cols-2 overflow-hidden rounded-xl bg-eb-blue">
          <div className="flex items-center gap-2.5 border-r border-white/25 px-4 py-5 sm:gap-6 sm:px-6">
          ...
          <div className="flex items-center gap-2.5 px-4 py-5 sm:gap-6 sm:px-6">
        ...
        <div className="mt-10 lg:mx-5">
          <div className="rounded-xl bg-white p-3 sm:p-8 lg:p-10">
            <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:grid-cols-3">
              ...
              <div className="col-span-2 flex flex-col rounded-lg bg-eb-cream p-5 sm:rounded-xl sm:p-7 lg:col-span-1 lg:col-start-3 lg:row-span-2 lg:row-start-1">
              ...
              <Link href="/courses" className="eb-cta group col-span-2 hidden items-center justify-between gap-4 rounded-lg bg-eb-cream py-3 pl-5 pr-3 text-left lg:col-span-1 lg:col-start-3 lg:row-start-3 lg:flex">
