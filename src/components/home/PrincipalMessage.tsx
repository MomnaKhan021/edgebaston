...
export function PrincipalMessage() {
  return (
    <section className="bg-eb-navy">
      <div className="mx-auto max-w-[1440px] px-4 py-14 lg:px-20 lg:py-20">
        ...
        <WordReveal
          ...
          className="mt-6 max-w-5xl text-2xl font-semibold leading-[1.25] text-white sm:text-3xl lg:text-[48px]"
        />
        <Link
          href="/about"
