      ...
      <div className="mx-auto max-w-[1440px] px-4 pb-10 pt-14 lg:px-10 lg:pb-10 lg:pt-20">
        ...
        <div className="relative mt-[60px] grid grid-cols-[1fr_auto_1fr] items-center gap-2 sm:gap-4">
          ...
          <div className="relative flex justify-center">
            ...
            <svg className="pointer-events-none absolute right-full top-[62%] mr-2 hidden w-[68px] lg:block lg:w-[98px]" viewBox="0 0 104 69" fill="none" aria-hidden>
            ...
            <svg className="pointer-events-none absolute left-full top-[16%] ml-2 hidden w-[68px] lg:block lg:w-[98px]" viewBox="0 0 104 69" fill="none" aria-hidden>
