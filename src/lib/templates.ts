  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        ...
        image("storyImage", "Story card — photo"),
        text("stat1Value", "Stat 1 — value (%)", "Number only, e.g. 76.0"),
        text("stat1Label", "Stat 1 — label"),
        text("stat2Value", "Stat 2 — value (%)", "Number only, e.g. 65.1"),
        text("stat2Label", "Stat 2 — label"),
        text("stat3Value", "Stat 3 — value (%)", "Number only, e.g. 87.7"),
        text("stat3Label", "Stat 3 — label"),
        color(),
      ],
      defaults: {
        visible: "1",
        ...
        body: "Every year our students achieve exceptional A-Level results. These outstanding grades reflect the consistent hard work of our students and the dedicated, individual support of our teachers throughout the year — turning ambitious targets into places at leading universities.",
        storyLabel: "See Success Story",
        storyLinkLabel: "See Success Story",
        storyLinkUrl: "/one-year-a-level-retake",
        storyImage: "/figma/pathway-1.webp",
        stat1Value: "76.0",
        stat1Label: "of grades at A*–A in core subjects",
        stat2Value: "65.1",
        stat2Label: "of grades at A*–A across all subjects",
        stat3Value: "87.7",
        stat3Label: "of grades at A*–B across all subjects",
        bgColor: "",
      },
    },
    {
      ...
      defaults: {
        ...
        subtitle: "Performance across our top-performing subjects.",
        subjects: JSON.stringify([
          { name: "Biology", grade: "A*–A", percent: "71.5" },
          { name: "Chemistry", grade: "A*–A", percent: "64.0" },
    ...
    },
    {
      ...
      defaults: {
        ...
        dest1Label: "of learners progressed to Russell Group universities",
        dest1Value: "72.7",
        dest2Label: "Medicine & Dentistry offer success rate",
        dest2Value: "92",
        bgColor: "",
      },
    },
